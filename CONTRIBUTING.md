...
This repository currently contains the project design, not an executable application. Add build and test commands when their implementations exist; do not describe planned functionality as working software.
